...
return [
	'user' => [
		'admin' => [
			'creation' => ['username' => 'What username do you want to use? (Type "exit" to finish the command)',
			...
			'update' => ['username' => 'Which admin do you want to update? (Type "exit" to finish the command)',
				...
				PHP_EOL . 'WARNING: The current one is indicated between square brackets' . PHP_EOL . '  1.- English' .
				PHP_EOL . '  2.- Castellano' . PHP_EOL . '  3.- Deutsch' . PHP_EOL,

	...
	'user' => ['greeting' => '¡Aviso!', 'line_2' => 'Su idioma escogido es el: ":language"',
		...
		'recruiter' => [
			'creation' => ['subject' => '¡Un nuevo reclutador :email creado!',
				'line_1' => 'La API ha registrado un nuevo reclutador ":email" con este perfil de LinkedIn ":linkedin_profile"',],
			'psswd' => ['subject' => '¡Usuario para la API del CV de Fran Lara creado!', 'greeting' => 'Bienvenido/a',
				...
				'line_2' => 'Endpoint: :endpoint', 'line_3' => 'Username: :username', 'line_4' => 'Passsword: :psswd',
